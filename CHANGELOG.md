...
* Plugin migrated from @steambrew/ttc to @steambrew/starlight build system. Requires Millennium v3.4.0+ and Bun. Plugin data directory changed from plugin folder to millennium/plugins/auto-claim-data/. plugin.json replaced with millennium.toml. @steambrew/* imports replaced with unified millennium module.
...
* remove toml from extra-files to fix release-please ([bf3eba9](https://github.com/BambooFury/Auto-Claim/commit/bf3eba9539cf0c7f488925c54045124f550c1178))
...
* migrate to starlight V2 plugin format ([68383e1](https://github.com/BambooFury/Auto-Claim/commit/68383e141e83240ec75a831fbe3c8c54394f6027))
